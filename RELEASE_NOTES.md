...
*   **Total Selection Freedom:** Captains can now select *any* active player, regardless of whether they marked themselves available. A new "Traffic Light" indicator (Green/Red/Grey) shows the player's true response intent.
