...
*   **Zami 1, Zami 2, Zomi Captains:** Can select their teams at any time. Their player pools are *independent* of the Kampong 1-5 cascade.
...
4. It will cycle through: `Yes (Green)` → `No (Red)` → `Excused (Blue)` → `Clear`.
   *   *Note: Use "Excused" for players on holiday or national duty so their reliability score isn't penalized.*
